  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(child: buildMetricCard('5+', 'Years Exp')),
            const SizedBox(width: 12),
            Expanded(child: buildMetricCard('30+', 'Shipped Apps')),
            const SizedBox(width: 12),
            Expanded(child: buildMetricCard('100%', 'Client Love')),
          ],
        ),
      ],
    ),
...
Widget buildMetricCard(String value, String title) {
  return Container(
